...
### 1. Create Task
*   **Propagation**: Nếu DTO có trường `assignedAt` ở root, service sẽ tự động copy giá trị này cho tất cả `TaskAssignee` con (nếu con chưa có ngày gán).
...
*   **Auto-Link & Propagation**: Tương tự như Create, logic tự động điền tên và ngày gán cũng được áp dụng khi update/insert assignee mới.
